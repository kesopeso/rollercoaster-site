...
ENV ROLL_FARM_CONTRACT_ADDRESS=${roll_farm_contract_address}
ENV ROLL_ETH_FARM_CONTRACT_ADDRESS=${roll_eth_farm_contract_address}
ENV BUY_BACK_CONTRACT_ADDRESS=${buy_back_contract_address}
ENV TREASURY_CONTRACT_ADDRESS=${treasury_contract_address}
